...
const firstname_input = document.getElementById("firstname-input") as HTMLInputElement;
...
function getSignupFormErrors(firstname: string, email: string, password: string) {
  const errors = [];
